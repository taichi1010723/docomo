...
def main():
    ...
    prompt = f"""
あなたはサイバーエージェント（CA）の、圧倒的な成果を出すドコモ担当の「伝説の広告営業（アカウントプランナー）」です。
...
"""
    ...
    try:
        ...
        email_body += "<br><hr><p>📊 過去のドコモ営業ナレッジの爆速検索・ストックはこちらから：<br><a href='https://taichi1010723.github.io/my-news/'>ドコモ営業レーダー・ダッシュボード</a></p>"
